...
<div class="wrapper">
    ...
    <div id="content">
                    ...
                    <ul class="nav navbar-nav ml-auto">
                        <li class="nav-item">
                            <a href="<c:url value="/send_money_page" />">
                                <button type="button" class="btn btn-primary btn-space"><spring:message
                                        code="button.send_money"/></button>
                            </a>
                        </li>
                        <li class="nav-item">
                            <button type="button" class="btn btn-info "><spring:message
                                    code="button.download"/></button>
                        </li>
                        <li class="nav-item">
        ...
        <h2><spring:message code="client.greeting"/> ${client.firstName}</h2>
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table">
                        <tr>
                            <td><spring:message code="client.name"/> :</td>
                            <td>${client.firstName}</td>
                        </tr>
                        <tr>
                            <td><spring:message code="client.last_name"/>:</td>
                            <td>${client.lastName}</td>
                        </tr>
                        <tr>
                            <td><spring:message code="client.phone_number"/> :</td>
                            <td>${client.phoneNumber}</td>
                        </tr>
                        <tr>
                            <td><spring:message code="client.address"/> :</td>
                            <td>${client.address.city} ${client.address.street}
                                ${client.address.house} ${client.address.apartment}</td>
                        </tr>
                        <tr>
